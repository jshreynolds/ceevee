...
I joined bettermarks to focus more on broad impact work. I improve the organzation's capacity for self-awareness and learning by improving the effectiveness of our techncial and social systems.  This includes identifying and establishing productive feedback loops in both software -- build systems, unit tests, development environmens, observability measures -- and human systems -- Radical Candor, blameless postmortems, modeling feedback requests, and more. I am very hands-on and use my deep practioner's expererience to help us stay grounded and appropriately whelmed as we give it a go!
...
During the pandemic I worked as a core team member of the technical staff of Untasked.

The work was very scrappy and hands on -- startup style! -- meaning I did whatever needed doing and filled any gaps that arose. Ulimately my focus was on DevOps technical architecture and implementation with some full stack development thrown in when needed.
